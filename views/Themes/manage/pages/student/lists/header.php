	...
	<div ref="actions" class="listpage2-actions">
		<div class="clearfix mbs mtm">
			...
			<ul class="lfloat" ref="actions">
				<li class="mt">
					<h2><i class="icon-graduation-cap mrs"></i><span><?=$this->lang->translate('Student')?></span></h2>
				</li>
				...
				<li class="mt"><a class="btn btn-blue" data-plugins="dialog" href="<?=URL?>student/add"><i class="icon-plus mrs"></i><span><?=$this->lang->translate('Add New')?></span></a></li>
		...
		<div class="clearfix mbl mtm">
			<ul class="lfloat" ref="control" data-plugins="select_faculty">
				<li>
					<label for="faculty" class="label"><?=$this->lang->translate('Faculty')?></label>
					<select ref="selector" name="faculty" class="inputtext">
						<option value="">-</option>
						<?php 
						foreach ($this->faculty['lists'] as $key => $value) {
				...
				<li>
					<label for="majors" class="label"><?=$this->lang->translate('Majors')?></label>
					<select ref="selector" name="majors" class="inputtext">
					</select>
				</li>
			</ul>
			<ul class="rfloat" ref="control">
